...
namespace ExcelDataManagementAPI.Models.DTOs
{
    ...
    // Macro iþlemleri için yeni DTO'lar
    public class MacroUpdateRequestDto
    {
        public string DocumentNumber { get; set; } = string.Empty;
        public int RowId { get; set; }
        
        [JsonPropertyName("updateData")]
        public Dictionary<string, string> UpdateData { get; set; } = new();
        
        public string? UpdatedBy { get; set; }
    }

    public class MacroUpdateItemDto
    {
        public int RowId { get; set; }
    ...
    public class MacroBulkUpdateRequestDto
    {
        public string DocumentNumber { get; set; } = string.Empty;
        public List<MacroUpdateItemDto> Updates { get; set; } = new();
        public string? UpdatedBy { get; set; }
    }
